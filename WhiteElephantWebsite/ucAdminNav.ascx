...
<div id="header">
    <asp:Image ID="logo" runat="server" ImageUrl="~/images/Logo.jpg" /><br />   
    ...
    <nav>
        <a href="~/admin/ProductMaintenance.aspx">Product Maintenance</a> &middot <a href="~/admin/OrderMaintenance.aspx">Order Maintenance</a> &middot <a href="~/admin/CategoryMaintenance.aspx">Category Maintenance</a>
